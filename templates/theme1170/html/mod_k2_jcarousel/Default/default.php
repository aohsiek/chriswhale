...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <ul id="<?php if($params->get('moduleclass_sfx')) echo $params->get('moduleclass_sfx'); ?>" class="jcarousel-skin-<?php echo $params->get("theme"); ?>">
    ...
    <li class="<?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
	  ...
	  <a class="moduleItemDateCreated-link" href="<?php echo $item->link; ?>">
			<span class="moduleItemDateCreated">
				<?php echo JHTML::_('date', $item->created, JText::_('K2_DATE_FORMAT_LC9')).'th, '.JHTML::_('date', $item->created, JText::_('K2_DATE_FORMAT_LC10')); ?>
			</span>
	</a>
      <?php endif; ?>
      ...
      <?php endif; ?>
        	...
        	<?php if($params->get('itemIntroText')): ?>
  			  <?php echo $item->introtext; ?> <!-- Last digit is a number of introtext symbols displayed -->
        	<?php endif; ?>
      </div>
...
(function($){ 
   $(window).load(function(){
	...
	$carousel_ul_id.jcarousel({
		vertical: <?php echo $params->get("vertical"); ?>,
        rtl: false,
        start: <?php echo $params->get("start"); ?>,
        offset: <?php echo $params->get("offset"); ?>,
        scroll: <?php echo $params->get("scroll"); ?>,
        visible: <?php echo $params->get("visible"); ?>,
        animation: 
        <?php 
          if(is_numeric($params->get("animation"))){
            echo $params->get("animation"); 
          } else {
            echo "'".$params->get("animation")."'"; 
          }
        ?>,
