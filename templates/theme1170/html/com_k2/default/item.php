...
require_once ($includesPath);
	...
	$detect = new Mobile_Detect();
		...
		$linkClass="modal img";
		$linkRel = "{handler: 'image'}";

		if(($detectMobile == true) && ($detectIphone == true)){
			$linkRel = "";
			$linkClass="";
		} 	
?>
		...
		<?php if($this->item->params->get('itemImage') && !empty($this->item->image)): ?>
			<div class="itemImageBlock">
				<span class="itemImage">
					...
					<?php else: ?>
						<a class="<?php echo $linkClass; ?>" rel="<?php echo $linkRel; ?>" href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>">
								<img src="<?php echo $this->item->image; ?>" alt="<?php if(!empty($this->item->image_caption)) echo K2HelperUtilities::cleanHtml($this->item->image_caption); else echo K2HelperUtilities::cleanHtml($this->item->title); ?>"/>
				...
				<li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
					...
					<div class="commentBody">
						...
						<span class="commentDate">
							<?php echo JHTML::_('date', $comment->commentDate, JText::_('K2_DATE_FORMAT_LC8')); ?>
						</span>
