...
<!-- Item list -->
	...
	<!-- Leading items -->
			<div id="itemListLeading">
				...
				$numLeadingGutter = $this->params->get('num_leading_columns') - 1;
				...
				<?php if($key%$column_number==0): ?>
					<div class="K2ItemsRow <?php echo 'K2Row-'.$key;?> cols<?php echo $this->params->get('num_leading_columns'); ?>">
				<?php endif; ?>
	...
	<!-- Primary items -->
			<div id="itemListPrimary">
				...
				$numPrimaryGutter = $this->params->get('num_primary_columns') - 1;
				...
				<?php if($key%$column_number==0): ?>
					<div class="K2ItemsRow <?php echo 'K2Row-'.$key;?> cols<?php echo $this->params->get('num_primary_columns'); ?>">
				<?php endif; ?>
	...
	<!-- Secondary items -->
			<div id="itemListSecondary">
				...
				$numSecondaryGutter = $this->params->get('num_secondary_columns') - 1;
				...
				<?php if($key%$column_number==0): ?>
					<div class="K2ItemsRow <?php echo 'K2Row-'.$key;?> cols<?php echo $this->params->get('num_secondary_columns'); ?>">
				<?php endif; ?>
...
<script type="text/javascript">
	(function($){ 
	   $(window).load(function(){
			...
			$('#port span.catItemImage a').touchTouch();
		});
	})(jQuery); 
</script> 
